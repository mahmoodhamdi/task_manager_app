...
// -- OnBoarding SubTitles2
  ...
  static const List<String> onBoardingSubTitlesList = [
    onBoardingSubTitle1,
    onBoardingSubTitle2,
    onBoardingSubTitle3
  ];
...
// -- Task Texts
  ...
  static const String tapToAddTask = "Tap + to add new task";
  ...
  static const String taskRepeat = "Task Repeat";
  ...
  //no priority
  static const String noPriority = "No Priority";
  //no status
